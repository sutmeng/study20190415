...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((plugins)|(mytest)|(upfile)|(Advertisement)|(login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(home)|(admin)).*";	//不对匹配该值的访问路径拦截（正则）
	public static ApplicationContext WEB_APP_CONTEXT = null; //该值会在web容器启动时由WebAppContextListener初始化
	public static final String ORCODEPATHIMG = "uploadFiles/QRCodeImgs/";
	/**
	 * APP Constants
	 */
	//系统用户注册接口_请求协议参数)
	...
	//	系統管理員
	public static final int SystemManageRoleId=1;
